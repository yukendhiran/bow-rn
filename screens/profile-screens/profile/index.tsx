      ...
      >
        <VStack className="h-full w-full pb-8" space="2xl">
          <Box className="relative w-full md:h-[478px] h-[380px]">
            <Image
              source={require("@/screens/profile-screens/profile/assets/image1.png")}
              height={"100%"}
              width={"100%"}
              alt="Banner Image"
              contentFit="cover"
          ...
          <Center className="absolute md:mt-14 mt-6 w-full md:px-10 md:pt-6 pb-4">
            <VStack space="lg" className="items-center">
              <Avatar size="2xl" className="bg-primary-600">
                <AvatarImage
                  alt="Profile Image"
                  source={require("@/screens/profile-screens/profile/assets/image.png")}
                />
                <AvatarBadge />
              </Avatar>
  ...
  return (
    <VStack className="md:hidden mb-5">
      <Box className="w-full h-[188px]">
        <Image
              source={require("@/screens/profile-screens/profile/assets/image2.png")}
          height={"100%"}
          width={"100%"}
          alt="Banner Image"
        />
...
export const Profile = () => {
  return (
    <SafeAreaView className="h-full w-full">
      <DashboardLayout title="Home" isSidebarVisible={true}>
        <MainContent />
      </DashboardLayout>
